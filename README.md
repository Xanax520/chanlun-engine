...
- **二三买选股公式**：在通达信中一键全市场扫描，5000 只个股约 30 秒–3 分钟出结果（一般家用 8-20 核电脑即可实现），把买卖点从"看图"变成"选股"。
...
- **买卖点**：二买、二卖、三买、三卖文字标记
- **二三买选股公式**：通达信条件选股扩展，全市场 5000 只个股扫描约 30 秒–3 分钟（一般家用 8-20 核电脑即可实现）
...
4. （可选）条件选股：Ctrl+F 新建「条件选股公式」，粘贴 `tdx_dll\formulas\缠论二三买选股公式.txt` 内容保存；「功能 → 选股器 → 条件选股」选择该公式即可全市场扫描二买/三买（5000 只个股约 30 秒–3 分钟）。
